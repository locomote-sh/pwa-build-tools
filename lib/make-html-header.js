    ...
    try {
        ...
        */
        ...
        if( serviceWorker ) {
            ...
            // The service worker URL. Note that it defaults here to a script in the
            // same directory as the page - the working assumption here is that PWA
            // entry points will always be in the root directory.
